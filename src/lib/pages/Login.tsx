...
const Login = () =>{
    ...
    return(
        <div className="h-screen w-screen bg-gradient-to-tr from-black to-sub">
            ...
            <div className="relative w-full h-full flex justify-center items-center flex-col gap-6 md:gap-10 py-40 px-[6vw] z-10 glass">
                ...
                <section>
                    <form onSubmit={hanldeLogin} className="flex flex-col gap-2 md:gap-4 md:min-w-[480px] min-w-[320px]">
